...
<body>
    ...
    <div class="mainSection">
        ...
        <div class="contentSection">
             ...
             <div class="menuBar">
                <ul>
                    <li><a href="../homeFile/studentHome.php">Home</a></li>
                    <li><a href="../studentOperationFile/checkAttendance.php">Check Attendance</a></li>
                    <li><a href="../studentOperationFile/semesterReport.php">Check semester report</a></li>
            ...
            <div class="view">
                <h1>WELCOME,</h1>
                <p>This is semester report page</p>
            </div>
